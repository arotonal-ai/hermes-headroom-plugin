...
class RuntimeManagerTest(unittest.TestCase):
    ...
    def test_setup_dry_run_is_no_write_and_disables_mutating_defaults(self):
        ...
        self.assertEqual(payload["headroom_spec"], "headroom-ai[proxy]==0.33.0")
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                ...
                patch.object(
                    manager,
                    "_ensure_runtime",
                    return_value=(cli, {"headroom": "0.33.0", "litellm": "1.94.0rc3"}),
                ),
    ...
    def test_package_spec_operator_is_strict(self):
        with self.assertRaises(ValueError):
            manager._validate_package_spec("headroom-ai[proxy]=>0.33.0", package="headroom-ai")
        with self.assertRaises(ValueError):
    ...
    def test_runtime_install_uses_isolated_official_pypi(self):
        with tempfile.TemporaryDirectory() as td, patch.dict(
            ...
            completed = [
                ...
                subprocess.CompletedProcess([str(python_exe)], 0, "0.33.0\n1.94.0rc3\n"),
            ]
