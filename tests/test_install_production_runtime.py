...
class InstallProductionRuntimeScriptTest(unittest.TestCase):
    def test_script_exists_and_has_safe_defaults(self):
        ...
        self.assertIn('LITELLM_RUNTIME_VERSION = "1.94.0rc3"', text)
        ...
        self.assertIn('HEADROOM_DISABLE_KOMPRESS"] = "1"', text)
        self.assertIn("Environment=HEADROOM_DISABLE_KOMPRESS=1", text)
    ...
    def test_docs_reference_portable_runtime_manager(self):
        ...
        self.assertIn("headroom-ai[proxy]==0.33.0", readme)
    ...
    def test_native_git_install_has_actionable_after_install(self):
        ...
        self.assertIn("RUNTIME_FULL_DURABLE", text)
        self.assertIn("headroom-ai[proxy]==0.33.0", text)
