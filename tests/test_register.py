...
class RegisterTest(unittest.TestCase):
    def test_register_core_surface(self):
        ...
        self.assertIn("decisions [turn [turn_id]]", command_handler("unknown"))
        ...
        self.assertIn("setup", command_kwargs.get("args_hint", ""))
        description = command_kwargs.get("description", "")
        self.assertIn("setup", description)
        self.assertIn("read-only guidance", description)
        self.assertIn("never installs silently", description)
        ...
        self.assertNotIn("retrieval-advice", command_kwargs.get("args_hint", ""))
        self.assertNotIn("cross-lane-advice", command_kwargs.get("args_hint", ""))
        self.assertNotIn("exact-reads", command_kwargs.get("args_hint", ""))
        self.assertNotIn("exact-read-lint", command_kwargs.get("args_hint", ""))
        self.assertNotIn("below-min", command_kwargs.get("args_hint", ""))
