...
required_text = {
    'pyproject.toml': ['version = "0.6.1"', 'requires-python = ">=3.11,<3.15"', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3', 'pytest==9.1.1'],
    ...
    'docs/AGENT-INSTALL.md': ['PASS if', 'PARTIAL if', 'FAIL if', 'headroom-ai[proxy]==0.32.1', 'scripts/headroom-runtime.py', 'headroom-runtime doctor --json', 'provider_mode=manual', 'mutations=[]', 'Python 3.13', 'Python 3.14', 'generate-weekly-savings-table.py', 'tool_execution', 'headroom-worker-lane'],
    'docs/portable-core.md': ['hermes-headroom-plugin==0.6.1', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3'],
