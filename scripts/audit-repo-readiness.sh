...
required_text = {
    'pyproject.toml': ['version = "0.6.2"', 'requires-python = ">=3.11,<3.15"', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3', 'pytest==9.1.1'],
    ...
    'docs/portable-core.md': ['hermes-headroom-plugin==0.6.2', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3'],
