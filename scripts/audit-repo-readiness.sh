...
required_text = {
    'pyproject.toml': ['version = "0.5.2"', 'headroom-ai[proxy]==0.32.1', 'litellm==1.91.3'],
    ...
    'docs/portable-core.md': ['hermes-headroom-plugin==0.5.2', 'headroom-ai[proxy]==0.32.1', 'litellm==1.91.3'],
