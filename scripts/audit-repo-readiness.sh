...
required_text = {
    'pyproject.toml': ['version = "0.6.3"', 'requires-python = ">=3.11,<3.15"', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3', 'pytest==9.1.1'],
    ...
    'INSTALL.md': ['Acceptance matrix', 'API keys', 'scripts/test-clean-hermes-install.sh --local', 'python scripts/test-headroom-dependency-install.py', 'python scripts/test-headroom-runtime-smoke.py', 'scripts/headroom-runtime.py', 'headroom-runtime setup', 'headroom-runtime status --json', 'headroom-runtime doctor --json', 'headroom-runtime uninstall --json', 'headroom-ai[proxy]==0.32.1', 'provider_mode=manual', 'targets=[]', 'mutations=[]', 'docs/runtime-manager.md', 'docs/compatibility.md', 'HEADROOM_ALLOW_REMOTE_PROXY', 'headroom-worker-lane', 'headroom-command-preflight', '/headroom setup'],
    ...
    'docs/AGENT-INSTALL.md': ['PASS if', 'PARTIAL if', 'FAIL if', 'headroom-ai[proxy]==0.32.1', 'scripts/headroom-runtime.py', 'scripts/run-isolated-unit-tests.py', 'headroom-runtime doctor --json', 'provider_mode=manual', 'mutations=[]', 'Python 3.12/3.13', '3.11/3.14', 'generate-weekly-savings-table.py', 'tool_execution', 'headroom-worker-lane'],
    ...
    'docs/portable-core.md': ['hermes-headroom-plugin==0.6.3', 'headroom-ai[proxy]==0.32.1', 'litellm==1.94.0rc3'],
    'docs/compatibility.md': ['Published v0.4.x baseline', 'Published v0.5.x runtime manager', 'Future Runtime Monitor', 'Python 3.13', 'Python 3.14', 'headroom-ai[proxy]==0.32.1'],
    ...
    'after-install.md': ['real savings are not active', 'PLUGIN_DIR=', 'scripts/headroom-runtime.py', 'headroom-runtime doctor --json', 'headroom-ai[proxy]==0.32.1', '/headroom smoke'],
