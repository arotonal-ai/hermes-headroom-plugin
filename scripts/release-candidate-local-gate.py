...
def workload_matrix(run_dir: Path, proxy_url: str, wheel_gate: dict[str, Any]) -> dict[str, Any]:
    ...
    cases = [
        ...
        {"name": "browser_debug_trace_hot_exact", "tool": "browser_snapshot", "args": {"lane": "browser debug", "data_class": "browser_debug_trace"}, "body": browser_trace(4200), "expect": "exact", "sentinel": "BROWSER_RC_SENTINEL"},
        {"name": "research_corpus_web_extract_hot_exact", "tool": "web_extract", "args": {"lane": "research", "data_class": "research_corpus"}, "body": research_corpus(4200), "expect": "exact", "sentinel": "RESEARCH_RC_SENTINEL"},
